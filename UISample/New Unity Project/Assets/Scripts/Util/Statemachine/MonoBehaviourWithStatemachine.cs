...
public abstract class SingletonMonoBehaviourWithStatemachine<T> : SingletonMonoBehaviour<SingletonMonoBehaviourWithStatemachine<T>> where T : struct
{
    ...
    public abstract class SingletonMonoBehaviourWithStatemachine<T, T2> : MonoBehaviourWithStatemachine<T2>
        where T2 : struct where T : SingletonMonoBehaviourWithStatemachine<T, T2>
    {
